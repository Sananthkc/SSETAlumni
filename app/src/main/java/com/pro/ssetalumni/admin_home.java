...
*/
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_pro:
                        Intent intent = new Intent(admin_home.this, Dashboard.class);
                        startActivity(intent);
                        intent.addFlags((Intent.FLAG_ACTIVITY_CLEAR_TOP));
                        break;
                    case R.id.nav_post:
                        Intent i = new Intent(admin_home.this, NewPost.class);
                        startActivity(i);

                        break;
                    case R.id.nav_event:

                        Intent j = new Intent(admin_home.this, EventPostNew.class);
                        startActivity(j);
                        finish();
                        break;
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new ImageAdapter(admin_home.this, mUploads);
